...
ili9341_color_rgb_t ili9341_rgb_wheel(uint16_t pos);
ili9341_color_t ili9341_color_wheel(uint16_t pos);
...
void ili9341_draw_bmp(ili9341_t* lcd,int start_x, int start_y, int end_x, int end_y, const uint16_t* test_img_128x128) ;
